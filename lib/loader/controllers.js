  ...
  function createRoutes(){
    ...
    _.each( caminio.config.routes, function( controllerStr, route ){
      ...
      if( _.contains( route.toLowerCase(), 'autorest' ) ){
        ...
        return autorest.create( controllerName, cleanRoute( route, 'autorest' ) );
      }
      ...
      if( _.contains( route.toLowerCase(), 'propfind') )
        return caminio.controller.createRoute( 'propfind', cleanRoute( route, 'propfind' ), controllerName, controllerAction );

      if( _.contains( route.toLowerCase(), 'options') )
        return caminio.controller.createRoute( 'options', cleanRoute( route, 'options' ), controllerName, controllerAction );
