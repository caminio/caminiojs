...
module.exports = function( caminio ){
  ...
  function createRoute( type, route, controllerName, controllerAction ){
    ...
    if( controllerName in ctrlStack ){
      ...
      var controller = ctrlStack[controllerName]( caminio, policiesStack, middlewareStack );

      if( !(controllerAction in controller) )
        return caminio.logger.error('controller', controllerName, 'has no action', controllerAction);
