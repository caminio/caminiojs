...
module.exports = function( caminio ){  
  ...
  function send( recipients, subject, templateName, options, callback ){
    ...
    var html = templateName ? processTemplate(templateName,options.locals) : options.text;
    juice.juiceContent( html, { url: options.url || 'http://camin.io' }, function(err,text){
      console.log( html, err, text );
