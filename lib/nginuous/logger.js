 ...
 */
function log( level, msg, subroutineCaller ){
  msg = '[nginuous' + (typeof(subroutineCaller) === 'string' ? '#'+subroutineCaller : '') + '] ' + msg;
  logger.log( level, msg );
}

module.exports.info = function( msg, subroutineCaller ){
  log('info', msg, subroutineCaller);
}

module.exports.warn = function( msg, subroutineCaller ){
  log('warn', msg, subroutineCaller);
}

module.exports.error = function( msg, subroutineCaller ){
  log('error', msg, subroutineCaller);
}
