var passport = require('passport')
  ...
  module.exports = function(){
    ...
    passport.deserializeUser(function(id, done) {
      nginuous.orm.models.User.findOne({ _id: id }, function(err, user ){
        done( err, user );
      });
    });
    ...
    passport.use('consumer', new ConsumerStrategy(
          ...
          function(consumerKey, done) {
            nginuous.orm.models.Client.findOne({ token: consumerKey }, function( err, client ){
    ...
    passport.use('token', new TokenStrategy(
      ...
      function(accessToken, done) {
        ...
        nginuous.orm.models.AccessToken.findOne({ token: accessToken }).populate('client').populate('user').exec( function(err, token) {
          if (err) { return done(err); }
