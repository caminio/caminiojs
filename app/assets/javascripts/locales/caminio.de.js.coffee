...
Em.merge Em.I18n.availableTranslations.de,
  ...
  password: 'Passwort'
  password_has_been_saved: 'Ihr neues Passwort wurde gespeichert'
  login: 'Anmelden'
  logout: 'Abmelden'
  aborted: 'Abgebrochen'
  status: 'Status'
  ...
  forgot_password_desc: 'Sie haben Ihr dein Passwort vergessen? Wir wissen es auch nicht. Es liegt verschlüsselt auf unserem Server gespeichert. Geben Sie Ihre Email Adresse an, und wir senden dir einen Link zu, mit dem Sie Ihr Passwort neu setzen können.'
  ...
  ok: 'Ok'
  cancel: 'Abbrechen'
  cancel_and_back: 'Abbrechen und zurück'
  close: 'Schließen'
  next: 'Weiter'
  previous: 'Zurück'
  finish: 'Abschließen'
